...
"""
A place for additional functionality associated with the repetition of shuffling for equilibrium cycles.
Typically these functions are utilized by a FuelHandler.
"""
